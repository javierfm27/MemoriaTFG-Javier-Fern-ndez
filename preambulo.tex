...
\usepackage{hyperref}
\usepackage{subfig}
\usepackage[justification=centering]{caption}%Centrar el titulo
\usepackage[stable]{footmisc} %Para notas de página en la cabecera de la sección
\renewcommand\bibname{Bibliografía} % Redefinimos el nombre de la bibliografía
\renewcommand{\contentsname}{Contenido}% Redefinimos el titulo del Índice
