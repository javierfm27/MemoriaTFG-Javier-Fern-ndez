...
Para nuestro proyecto, se ha decidido lanzar el software bajo la licencia Apache versión 2.0. Para poder aplicar dicha licencia, se crea un archivo de texto plano en el directorio raíz del proyecto con nombre \textt{LICENSE} donde incluiremos todas las condiciones que está licencia aplica. 
