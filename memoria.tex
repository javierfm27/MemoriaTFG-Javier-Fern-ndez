...
[[  PREGUNTAR TUTOR, COMO QUEREMOS REDACTAR ESTA PARTE]
    ...
    %%
    % 2.2 - CONTROL DE VERSIONES CON GIT. GITHUB
    %%
...
\begin{enumerate}
    ...
    \item ¿En \ref{sec:git} hablamos de las ramificaciones?.
    ...
    \item Al código que incluyo también le tengo que indicar poner pie de foto, cuando digo pie de foto, me refiero a incluirlo como figura.
    \item ¿El título se discute ahora, o una vez que el proyecto está acabado?
    \item ¿El resumen debo ponerlo al principio de la memoria o al final?
    \item ¿Defino un estilo para el código del Font Matter?
    \item ¿Herramienta para el diseño de figuras gráficas?
    \item ¿Qué es una Gem Ruby?
    \end{enumerate}
...
\begin{enumerate}
    ...
    \item Recordad añadir pie de fotos a las partes con código si al final es necesario
\end{enumerate}
